...
// 2.
radiologiaHtml.textContent = `Radiologia Primera atención: ${radiologiaArray[0].paciente} - ${radiologiaArray[0].prevision} | Última atención:${radiologiaArray[radiologiaArray.length - 1].paciente}`
